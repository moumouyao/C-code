...
//	功能
struct INFOR infor[] = {{"/home/yyy/linux/2银行/src/open", "open"},	//开户功能		
						{"/home/yyy/linux/2银行/src/dep", "dep"},
						{"/home/yyy/linux/2银行/src/disdep", "disdep"},
						{"/home/yyy/linux/2银行/src/check", "check"},
						{"/home/yyy/linux/2银行/src/trans", "trans"},
						{"/home/yyy/linux/2银行/src/delac", "delac"}
						};
int main(){
	signal(2, stop);//信号改造
	//创建消息队列
